...
// -----------------------------------------
$result = $qlgame->queryDB("SELECT * FROM NHA_PHAT_TRIEN LIMIT $offset, $rowsPerPage");
    ...
    while ($rows = mysqli_fetch_array($result)) {
      ...
      $str .= "<td>
        <div class='form-button-action'>
          <a href='" . $_SERVER['PHP_SELF'] . "?tag=updateNPT&id=$id&page=". $_GET['page'] ."'>
          ...
          <a href='" . $_SERVER['PHP_SELF'] . "?tag=deleteNPT&id=$id&page=". $_GET['page'] ."'>
...
echo "<a href='" . $_SERVER['PHP_SELF'] . "?tag=createNPT&page=". $_GET['page'] ."'>Add Developer<i class='fa-solid fa-user-plus ml-1'></i></a>";
?>
