<div class="menu">
	<nav id="web-navbar" class="navbar navbar-expand-lg navbar-dark">
		...
		<form class="form-inline ml-3 mr-3" method="post">
			<div class="input-group">
				<div class="input-group-prepend">
					<button type="submit" name="btn-search" class="input-group-text" id="basic-addon1"><i class="fa-solid fa-magnifying-glass"></i></button>
					<input name="inp-search" type="text" class="form-control btn-dark" placeholder="Search store" aria-label="Search" aria-describedby="basic-addon1">
				</div>
			</div>
		</form>
		<ul id="web-navbar-nav" class="navbar-nav" style="width: 100%;">
			<li class="nav-item">
