...
<nav class="navbar navbar-expand-lg navbar-dark">
  <!-- <div class="container"> -->
        ...
        <!-- <form class="form-inline my-2 my-lg-0">
            <input class="form-control btn btn-dark mr-sm-2" type="search" placeholder="Search store" aria-label="Search">
        </form> -->
        <form class="form-inline ml-3 mr-3">
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-magnifying-glass"></i></span>
                    <input type="text" class="form-control btn-dark" placeholder="Search store" aria-label="Search" aria-describedby="basic-addon1">
                </div>
            </div>
        ...
        <form class="form-inline my-2 my-lg-0">
            <button class="btn btn-dark my-2 my-sm-0" type="submit" style="font-size: 10px;"><i class="fa-solid fa-user" style="padding-right:15px;"></i>SIGN IN</button>
        </form>
  <!-- </div> -->
</nav>
</div>
