...
if (isset($_POST['dangNhap'])) 
{
    ...
    echo "<div class='notify'>Login successful. <a href='/my_web/QLGame/web.php'>Homepage</a></div>";
    die();
}
?>
...
>>>>>>> 1f275488c67c1914c1f9a9c57e0c9b4b2594f3d9
                                    <h5 class="mt-3" style="color:white;">Sign in with your account</h5>
                                </div>
                            </div>
                            <div class="card-body">
<<<<<<< HEAD
...
>>>>>>> 1f275488c67c1914c1f9a9c57e0c9b4b2594f3d9
                                    <div class="form-floating mb-3">
                                        ...
                                        <div class="form-outline mb-4">
                                            <input type="text" id="tenDN" name="tenDN" class="form-control-lg btn-dark" placeholder="Sign In name"/>                                           
                                        </div>
                                       
                                        <div class="form-outline mb-4">
                                            <input type="password" id="matKhau" name="matKhau" class="form-control-lg btn-dark" placeholder="Password"/>                                           
                                        </div>

                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><input type="submit" id="dangNhap" name="dangNhap" value="Sign in now" class="btn-primary form-control-lg" /></div>
                                        </div>
                            ...
                            <div class="card-footer text-center py-3">
                                <div class="small" style="color:white;">Don't have an account? <a href="register.php" style="color:white;font-weight:bold;">Sign Up</a></div>
                            </div>
                        </div>
                    </div>
                </div>
