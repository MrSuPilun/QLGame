...
<link rel="stylesheet" href="assets/vendor/fontawesome-free-6.2.0-web/css/all.min.css">
<link rel="stylesheet" href="/my_web/QLGame/assets/vendor/bootstrap-4.6.2-dist/css/bootstrap.min.css" type="text/css" media="screen" />
>>>>>>> 1f275488c67c1914c1f9a9c57e0c9b4b2594f3d9
...
>>>>>>> 1f275488c67c1914c1f9a9c57e0c9b4b2594f3d9
                                    ...
                                    <div class="card-body">
                                        <form align='center' action='xlRegister.php' method='POST'>                                         
                                            <div class="form-floating mb-3">
                                                    ...
                                                    <div class="form-row mb-3">
                                                        <div class="form-group col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                <input type="text" id="info" name="hoTen" class="form-control-lg btn-dark" placeholder="Full name"/>                                    
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="text" id="info" name="email" class="form-control-lg btn-dark" placeholder="Email address"/>                                                               
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="text" id="info" name="sdt" class="form-control-lg btn-dark" placeholder="Phone number"/>                                                               
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="text" id="info" name="diaChi" class="form-control-lg btn-dark" placeholder="Address"/>                                                               
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-4">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="text" id="account" name="tenDN" class="form-control-lg btn-dark" placeholder="Sign In name"/>                                                               
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-4">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="password" id="account" name="matKhau" class="form-control-lg btn-dark" placeholder="Password"/>                                                               
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-4">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                            <input type="password" id="account" name="xNMK" class="form-control-lg btn-dark" placeholder="Re-type Password"/>                                                               
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-4 mb-0">
                                                    <div class="d-grid"><input type="submit" id="dangKy" name="dangKy" value="Sign up" class="btn-primary form-control-lg" /></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small" style="color:white;">Have an account! <a href="sign_in.php" style="color:white;font-weight:bold;">Sign In</a></div>
                                    </div>                                
                            </div>
                        </div>
                    </div>
