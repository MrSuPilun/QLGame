          ...
          <div class="col-lg-9">
            <div class="card shadow-lg border-0 rounded-lg mt-5 bg-dark">
              ...
              <div class="card-footer text-center py-3">
                <form method="POST">
                  <div class="small" style="color:white;">Have an account! <button name="login" style="color:white;font-weight:bold;background-color: transparent;">Sign In</button></div>
                </form>
              </div>
            </div>
          </div>
